const baseurl = "http://15875287.ngrok.io/public/imagemap/get";
const searchUrl = "http://15875287.ngrok.io/public/imagemap/search";
const allFloorLevelUrl = "http://15875287.ngrok.io/public/imagemap/getAll";
...
try {
  ...
  function searchRoom(title) {
    ...
    const area_m = [];
    let filteredMapdata = allMapData.find(
